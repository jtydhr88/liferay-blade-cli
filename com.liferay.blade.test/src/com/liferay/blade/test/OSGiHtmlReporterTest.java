...
"</html>\n";
		...
		reporter.report(new Problem(
				...
				110, null, null, Problem.STATUS_NOT_RESOLVED, Problem.DEFAULT_MARKER_ID, Problem.ERROR));
		reporter.report(new Problem(
				"bar", "bar summary", "jsp", "LPS-867", new File("Bar.java"), 20, 200,
				220, null, null, Problem.STATUS_NOT_RESOLVED, Problem.DEFAULT_MARKER_ID, Problem.ERROR));
