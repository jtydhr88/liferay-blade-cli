...
import com.liferay.blade.upgrade.liferay70.apichanges.DDMXMLUtilInvocation;
...
public class DDMXMLUtilInvocationTest extends BaseAPIChangesTest {
	...
	public void dDMXMLUtilInvocationTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof DDMXMLUtilInvocation) {
