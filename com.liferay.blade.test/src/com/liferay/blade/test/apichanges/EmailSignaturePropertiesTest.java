...
import com.liferay.blade.upgrade.liferay70.apichanges.EmailSignatureProperties;
...
public class EmailSignaturePropertiesTest extends BaseAPIChangesTest {
	...
	public void emailSignaturePropertiesAnalyzeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof EmailSignatureProperties) {
