...
import com.liferay.blade.upgrade.liferay70.apichanges.ContactNameExceptionImport;
...
public class ContactNameExceptionImportTest extends BaseAPIChangesTest {
	...
	public void assetDLgetEntriesTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof ContactNameExceptionImport) {
