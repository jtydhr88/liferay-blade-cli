...
public class AssetRendererAndWorkflowHandlerRenderInvocationTest extends BaseAPIChangesTest {
	...
	public void assetRenderTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof AssetRendererAndWorkflowHandlerRenderInvocation) {
