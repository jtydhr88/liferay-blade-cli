...
import com.liferay.blade.upgrade.liferay70.apichanges.AssetRendererGetSummaryDecl;
...
public class AssetRendererGetSummaryDeclTest extends BaseAPIChangesTest {
	...
	public void assetRendererAPIsAnalyzeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof AssetRendererGetSummaryDecl) {
