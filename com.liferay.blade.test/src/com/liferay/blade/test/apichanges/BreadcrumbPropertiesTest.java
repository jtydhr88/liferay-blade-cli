...
import com.liferay.blade.upgrade.liferay70.apichanges.BreadcrumbProperties;
...
public class BreadcrumbPropertiesTest extends BaseAPIChangesTest {
	...
	public void breadcrumbPropertiesAnalyzeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof BreadcrumbProperties) {
