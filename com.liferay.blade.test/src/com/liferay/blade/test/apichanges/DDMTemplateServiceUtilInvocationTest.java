...
import com.liferay.blade.upgrade.liferay70.apichanges.DDMTemplateServiceUtilInvocation;
...
public class DDMTemplateServiceUtilInvocationTest extends BaseAPIChangesTest {
	...
	public void ddmTemplateServiceTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof DDMTemplateServiceUtilInvocation) {
