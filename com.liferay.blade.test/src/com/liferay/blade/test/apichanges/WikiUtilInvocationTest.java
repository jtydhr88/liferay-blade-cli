...
import com.liferay.blade.upgrade.liferay70.apichanges.WikiUtilInvocation;
...
public class WikiUtilInvocationTest extends BaseAPIChangesTest {
	...
	public void wikiUtilAnalyzeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof WikiUtilInvocation) {
