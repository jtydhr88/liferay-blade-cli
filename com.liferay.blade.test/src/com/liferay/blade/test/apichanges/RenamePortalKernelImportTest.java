...
import com.liferay.blade.upgrade.liferay70.apichanges.RenamePortalKernelImports;
...
public class RenamePortalKernelImportTest extends BaseAPIChangesTest {
	...
	public void renamePortalKernelImportTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof RenamePortalKernelImports) {
