...
import com.liferay.blade.upgrade.liferay70.apichanges.DDMStructureUpdateStructureInvocation;
...
public class DDMStructureUpdateStructureInvocationTest extends BaseAPIChangesTest {
	...
	public void ddmSStructureAnalyzeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof DDMStructureUpdateStructureInvocation) {
