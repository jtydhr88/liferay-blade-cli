...
import com.liferay.blade.upgrade.liferay70.apichanges.AssetRendererGetURLViewDecl;
...
public class AssetRendererGetURLViewDeclTest extends BaseAPIChangesTest {
	...
	public void assetRendererAPIsAnalyzeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof AssetRendererGetURLViewDecl) {
