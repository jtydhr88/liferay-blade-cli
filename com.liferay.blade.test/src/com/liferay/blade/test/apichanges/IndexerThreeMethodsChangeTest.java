...
import com.liferay.blade.upgrade.liferay70.apichanges.IndexerThreeMethodsChange;
...
public class IndexerThreeMethodsChangeTest extends BaseAPIChangesTest {
	...
	public void testIndexerThreeMethodsChangeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof IndexerThreeMethodsChange) {
