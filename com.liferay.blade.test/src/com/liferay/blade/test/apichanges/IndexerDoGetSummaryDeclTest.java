...
public class IndexerDoGetSummaryDeclTest extends BaseAPIChangesTest {
	final File testFile = new File(
			"projects/knowledge-base-portlet-6.2.x/docroot/WEB-INF/src/com/liferay/knowledgebase/admin/util/AdminIndexer.java");
	...
	public void indexerDoGetSummaryDeclTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof IndexerDoGetSummaryDecl) {
