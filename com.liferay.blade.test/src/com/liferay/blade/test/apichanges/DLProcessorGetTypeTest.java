...
import com.liferay.blade.upgrade.liferay70.apichanges.DLProcessorGetType;
...
public class DLProcessorGetTypeTest extends BaseAPIChangesTest {
	...
	public void assetDLProcessorGetTypeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof DLProcessorGetType) {
