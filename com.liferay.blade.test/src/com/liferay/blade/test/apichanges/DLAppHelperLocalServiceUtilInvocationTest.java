...
public class DLAppHelperLocalServiceUtilInvocationTest extends BaseAPIChangesTest {
	final File testFile = new File(
			"projects/test-ext/docroot/WEB-INF/ext-impl/src/com/liferay/test/DLAppHelperLocalServiceUtilTest.java");
	...
	public void dlAppHelperLocalServiceTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof DLAppHelperLocalServiceUtilInvocation) {
