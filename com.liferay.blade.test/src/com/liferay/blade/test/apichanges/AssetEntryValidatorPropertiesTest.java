...
import com.liferay.blade.upgrade.liferay70.apichanges.AssetEntryValidatorProperties;
...
public class AssetEntryValidatorPropertiesTest extends BaseAPIChangesTest {

	final File testFile = new File("projects/test-portlet/docroot/WEB-INF/src/portal.properties");
	...
	public void assetEntryValidatorPropertiesAnalyzeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof AssetEntryValidatorProperties) {
