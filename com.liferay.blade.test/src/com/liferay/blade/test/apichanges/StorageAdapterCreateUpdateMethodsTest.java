...
import com.liferay.blade.upgrade.liferay70.apichanges.StorageAdapterCreateUpdateMethods;
...
public class StorageAdapterCreateUpdateMethodsTest extends BaseAPIChangesTest {
	...
	public void storageAdapterCreateUpdateTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof StorageAdapterCreateUpdateMethods) {
