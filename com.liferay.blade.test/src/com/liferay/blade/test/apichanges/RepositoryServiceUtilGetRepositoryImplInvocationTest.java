...
public class RepositoryServiceUtilGetRepositoryImplInvocationTest extends BaseAPIChangesTest {

	final File testFile = new File("projects/filetests/RepositoryServiceUtilTest.java");
	final File jspFile = new File("projects/filetests/RepositoryServiceUtilTest.jsp");
	...
	public void repositoryServiceUtilAnalyzeTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof RepositoryServiceUtilGetRepositoryImplInvocation) {
