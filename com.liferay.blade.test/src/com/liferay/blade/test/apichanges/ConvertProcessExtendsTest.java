...
import com.liferay.blade.upgrade.liferay70.apichanges.ConvertProcessExtends;
...
public class ConvertProcessExtendsTest extends BaseAPIChangesTest {
	...
	public void convertProcessExtends() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof ConvertProcessExtends) {
