 ...
 * @author Andy Wu
 */
public class MVCPortletInitParamsChangeClassTest extends BaseAPIChangesTest {

	private final File testFile = new File("projects/knowledge-base-portlet-6.2.x/docroot/"
	...
	public void testMVCPortletChangeExtendsTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof MVCPortletInitParamsChangeClass) {
