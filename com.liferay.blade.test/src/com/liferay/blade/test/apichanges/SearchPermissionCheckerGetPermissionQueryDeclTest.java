...
import com.liferay.blade.upgrade.liferay70.apichanges.SearchPermissionCheckerGetPermissionQueryDecl;
...
public class SearchPermissionCheckerGetPermissionQueryDeclTest extends BaseAPIChangesTest {
	...
	public void searchPermissionCheckerTest() throws Exception {
		...
		for (ServiceReference<FileMigrator> fm : fileMigrators) {
			...
			if (fmigrator instanceof SearchPermissionCheckerGetPermissionQueryDecl) {
